...
let sectionsCount = document.getElementsByClassName("landing__container")
  .length;
...
for (i = 1; i <= sectionsCount ; i++) {
  ...
  let newItemText = document.createTextNode(itemText);
  ...
  //Adds button to scrolls into section to view it 
...
//Checks if section is in view and adds active-class with moving background and color change for it
...
//Add sticky header as per review
